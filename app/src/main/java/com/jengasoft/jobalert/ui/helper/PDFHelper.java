...
public class PDFHelper {
    ...
    public static void downloadAndOpenPDF(final Context context, final String pdfUrl) {
        ...
        final ProgressDialog progress = ProgressDialog.show(context, context.getString(
                R.string.pdf_show_local_progress_title), context.getString(
                R.string.pdf_show_local_progress_content), true);
